...
- (void)testRequestParameters
{
    ...
    NSString *theIDFV = signedParameters[@"d_idfv"];
    ...
    if (PH_SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"6.0"))
    {
        ...
        NSString *theIDFVParameter = [NSString stringWithFormat:@"d_idfv=%@", theIDFV];
    ...
    else
    {
        ...
        STAssertTrue([theRequestURL rangeOfString:@"d_idfv="].length == 0, @"This parameter should "
